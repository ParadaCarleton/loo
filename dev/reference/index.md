...
- [`loo-package`](https://mc-stan.org/loo/dev/reference/loo-package.md)
  : Efficient LOO-CV and WAIC for Bayesian models
- [`loo-glossary`](https://mc-stan.org/loo/dev/reference/loo-glossary.md)
  : LOO package glossary
- [`loo-datasets`](https://mc-stan.org/loo/dev/reference/loo-datasets.md)
  [`Kline`](https://mc-stan.org/loo/dev/reference/loo-datasets.md)
  [`milk`](https://mc-stan.org/loo/dev/reference/loo-datasets.md)
  [`voice`](https://mc-stan.org/loo/dev/reference/loo-datasets.md)
  [`voice_loo`](https://mc-stan.org/loo/dev/reference/loo-datasets.md) :
...
- [`loo()`](https://mc-stan.org/loo/dev/reference/loo.md)
  [`loo_i()`](https://mc-stan.org/loo/dev/reference/loo.md)
  [`is.loo()`](https://mc-stan.org/loo/dev/reference/loo.md)
...
- [`loo_moment_match_split()`](https://mc-stan.org/loo/dev/reference/loo_moment_match_split.md)
  ...
  cross-validation (LOO)
- [`E_loo()`](https://mc-stan.org/loo/dev/reference/E_loo.md) : Compute
  weighted expectations
- [`psis()`](https://mc-stan.org/loo/dev/reference/psis.md)
  [`is.psis()`](https://mc-stan.org/loo/dev/reference/psis.md)
  [`is.sis()`](https://mc-stan.org/loo/dev/reference/psis.md)
  [`is.tis()`](https://mc-stan.org/loo/dev/reference/psis.md) : Pareto
  smoothed importance sampling (PSIS)
- [`ap_psis()`](https://mc-stan.org/loo/dev/reference/ap_psis.md) :
  Pareto smoothed importance sampling (PSIS) using approximate
  posteriors
...
- [`importance_sampling()`](https://mc-stan.org/loo/dev/reference/importance_sampling.md)
  : A parent class for different importance sampling methods.
- [`weights(`*`<importance_sampling>`*`)`](https://mc-stan.org/loo/dev/reference/weights.importance_sampling.md)
...
- [`pareto_k_table()`](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
  ...
  [`pareto_k_values()`](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
  [`pareto_k_influence_values()`](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
  [`psis_n_eff_values()`](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
  [`mcse_loo()`](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
  [`plot(`*`<psis_loo>`*`)`](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
  [`plot(`*`<psis>`*`)`](https://mc-stan.org/loo/dev/reference/pareto-k-diagnostic.md)
...
- [`loo_compare()`](https://mc-stan.org/loo/dev/reference/loo_compare.md)
  ...
  [`print(`*`<compare.loo_ss>`*`)`](https://mc-stan.org/loo/dev/reference/loo_compare.md)
  : Model comparison
...
- [`kfold_split_random()`](https://mc-stan.org/loo/dev/reference/kfold-helpers.md)
  ...
  [`kfold_split_grouped()`](https://mc-stan.org/loo/dev/reference/kfold-helpers.md)
  : Helper functions for K-fold cross-validation
- [`kfold()`](https://mc-stan.org/loo/dev/reference/kfold-generic.md)
  [`is.kfold()`](https://mc-stan.org/loo/dev/reference/kfold-generic.md)
  : Generic function for K-fold cross-validation for developers
- [`elpd()`](https://mc-stan.org/loo/dev/reference/elpd.md) : Generic
...
- [`crps()`](https://mc-stan.org/loo/dev/reference/crps.md)
  ...
  [`loo_crps()`](https://mc-stan.org/loo/dev/reference/crps.md)
  [`loo_scrps()`](https://mc-stan.org/loo/dev/reference/crps.md) :
...
- [`waic()`](https://mc-stan.org/loo/dev/reference/waic.md)
  [`is.waic()`](https://mc-stan.org/loo/dev/reference/waic.md) : Widely
...
- [`print(`*`<loo>`*`)`](https://mc-stan.org/loo/dev/reference/print.loo.md)
  [`print(`*`<waic>`*`)`](https://mc-stan.org/loo/dev/reference/print.loo.md)
  [`print(`*`<psis_loo>`*`)`](https://mc-stan.org/loo/dev/reference/print.loo.md)
  [`print(`*`<importance_sampling_loo>`*`)`](https://mc-stan.org/loo/dev/reference/print.loo.md)
...
- [`obs_idx()`](https://mc-stan.org/loo/dev/reference/obs_idx.md) : Get
  observation indices used in subsampling

- [`update(`*`<psis_loo_ss>`*`)`](https://mc-stan.org/loo/dev/reference/update.psis_loo_ss.md)
  :
...
- [`psislw()`](https://mc-stan.org/loo/dev/reference/psislw.md) : Pareto
